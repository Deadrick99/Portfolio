  ...
  theme: {
    extend: {
      ...
      animation: {
        ...
        slideRight2: "slideRight 1.5s ease-out",
        slideRight3: "slideRight 2s ease-out",
        slideRight4: "slideRight 2.5s ease-out",
        slideRight5: "slideRight 3s ease-out",
        slideLeft: "slideLeft 1s ease-out",
        slideLeft2: "slideLeft 1.5s ease-out",
        slideLeft3: "slideLeft 2s ease-out",
        slideLeft4: "slideLeft 2.5s ease-out",
        slideLeft5: "slideLeft 3s ease-out",
      },
    },
  },
  plugins: [],
